...
const uint8_t  USBD_ConfigDescriptor[] = { 
    ...
    0x01,                           // bNumDescriptors
    0x22,                           // bDescriptorType
    USBD_SIZE_REPORT_DESC_CD & 0xFF, USBD_SIZE_REPORT_DESC_CD >> 8, // wItemLength
    ...
    0x03,                           // bmAttributes
    DEF_ENDP_SIZE_CD & 0xFF, DEF_ENDP_SIZE_CD >> 8, // wMaxPacketSize
    0x0A                            // bInterval: 10mS
...
const uint8_t USBD_ConsumerRepDesc[USBD_SIZE_REPORT_DESC_CD] = {
    0x05, 0x0c,                    // USAGE_PAGE (Consumer Devices)
    ...
    0x75, 0x01,                    //   REPORT_SIZE (1) - Padding size

    0x95, 0x04,                    //   REPORT_COUNT (4) - Padding count
