...
#define DEF_ENDP_SIZE_MS            5
#define DEF_ENDP_SIZE_CD            1

       
#define USBD_SIZE_DEVICE_DESC        18
#define USBD_SIZE_CONFIG_DESC        84
#define USBD_SIZE_REPORT_DESC_KB     62
#define USBD_SIZE_REPORT_DESC_MS     118 //52
#define USBD_SIZE_REPORT_DESC_CD     31
...
extern const uint8_t USBD_ConsumerRepDesc[USBD_SIZE_REPORT_DESC_CD];
